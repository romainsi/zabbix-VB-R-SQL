...
#Configure sqlquery function with user/pass (line 64-65), create user/pass in sql server and reader rights , permit to connect with local user in sql settings.
$veeamserver = 'veeam.contoso.local'
$pathzabbixsender = 'C:\Program Files\Zabbix Agent 2'
...
switch ($ITEM) {
    "StartJobs" {
        ...
        .\zabbix_sender.exe -c .\zabbix_agent2.conf -k ResultsBackup -o $Return
        ...
        .\zabbix_sender.exe -c .\zabbix_agent2.conf -k ResultsBackupSync -o $Return
        ...
        if ($Return) {
            .\zabbix_sender.exe -c .\zabbix_agent2.conf -k ResultsBackupTape -o $Return
        }
        ...
        .\zabbix_sender.exe -c .\zabbix_agent2.conf -k RepoInfo -o $return
    }
